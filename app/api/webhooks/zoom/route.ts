...
async function handleRecordingCompleted(payload: any, db: any) {
  ...
  try {
    ...
    // Create transcription record - since we removed the Transcription model,
    // we'll need to either update this to use CallRecord or create a new collection
    // For now, let's just log the data
    console.log(`Zoom recording completed for meeting: ${uuid}`, {
